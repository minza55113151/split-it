...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
  expenses = {
     ...
     * @secure
     */
    expensesUpdate: (id: string, expense: ModelsExpense, params: RequestParams = {}) =>
      this.request<string, string>({
        path: `/expenses/${id}`,
        method: "PUT",
        body: expense,
     ...
     * @request GET:/expenses/{status}
     * @secure
     */
    expensesDetail: (status: string, params: RequestParams = {}) =>
  ...
  friends = {
    ...
    friendsList: (params: RequestParams = {}) =>
      this.request<ModelsFriend[], string>({
        path: `/friends`,
        method: "GET",
        secure: true,
        type: ContentType.Json,
